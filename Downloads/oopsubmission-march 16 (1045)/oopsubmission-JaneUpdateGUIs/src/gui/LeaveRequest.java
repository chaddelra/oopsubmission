...
public class LeaveRequest extends javax.swing.JFrame {
    ...
    public LeaveRequest(User user) {
        ...
        if (user instanceof Employee) {
            this.employeeUser = (Employee) user;
        }
    ...
    private void loadLeaveRequests() {
        ...
        // Load leave request data from CSV processor
        for (Map<String, String> request : csvProcessor.getAllLeaveRequestRecords()) {
            if (request.get("Employee ID").equals(employeeId)) {
        ...
        // If no records were found, add sample data
            ...
            if (loggedInUser != null) {
                ...
                switch (loggedInUser.getRole()) {
                    ...
                    default:
                        ...
                        System.err.println("Unknown role: " + loggedInUser.getRole() + ", using fallback navigation");
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Sick Leave ", "Vacation Leave " }));
